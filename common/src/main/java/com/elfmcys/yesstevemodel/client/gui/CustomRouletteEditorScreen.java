...
public class CustomRouletteEditorScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick) {
        ...
        // 左面板标题
        g.text(this.font, Component.literal("Available Animations"), leftX, topY - 2, 0xFFAAAAAA, true);
        // 右面板标题
        g.text(this.font, Component.literal("Custom Layout"), rightX, topY - 2, 0xFFAAAAAA, true);
