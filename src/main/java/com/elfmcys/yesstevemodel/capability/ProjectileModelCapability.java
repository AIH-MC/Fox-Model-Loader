...
public class ProjectileModelCapability {
        ...
        return com.elfmcys.yesstevemodel.neoforge.capability.NeoForgeCapabilities.getProjectileModel(entity);
    }

        public static Optional<ProjectileModelCapability> get(Projectile projectile) {
        return com.elfmcys.yesstevemodel.neoforge.capability.NeoForgeCapabilities.getProjectileModel(projectile);
    }
