...
import net.neoforged.api.distmarker.Dist;import net.neoforged.api.distmarker.OnlyIn;import rip.ysm.compat.bettercombat.BetterCombatCompat;
...
public final class PlayerCapability extends CustomPlayerEntity {
        ...
        return com.elfmcys.yesstevemodel.capability.client.PlayerCapabilityClientStore.get(player);
    }

        public static Optional<PlayerCapability> get(Entity entity) {
        if (!(entity instanceof Player p)) return Optional.empty();
        return com.elfmcys.yesstevemodel.capability.client.PlayerCapabilityClientStore.get(p);
    }
