...
public final class AnimationFrameProfiler {
    ...
    public static void beginRenderFrame(float partialTick) {
        ...
        if (isEnabled() && GeneralConfig.safeGet(GeneralConfig.ANIMATION_DEBUG_LOG, false)) {
            YesSteveModel.LOGGER.info("[YSM-ANIM] frame={} partialTick={}", renderFrameId, partialTick);
        }
    }
    ...
    public static void logReusedEvaluation(AnimatableEntity<?> animatable, AnimationEvent<?> event, float seekTime) {
        ...
        YesSteveModel.LOGGER.info("[YSM-ANIM] reuse frame={} entity={} model={} tick={} partial={} frameTime={} seekTime={}",
                renderFrameId,
    ...
    public static void logReuseMiss(AnimatableEntity<?> animatable, AnimationEvent<?> event, String reason, float seekTime, float previousSeekTime, boolean animationActive, boolean previousAnimationActive, int boneCount, int previousBoneCount, int controllerCount, int previousControllerCount) {
        ...
        YesSteveModel.LOGGER.info("[YSM-ANIM] reeval frame={} entity={} model={} reason={} tick={} partial={} frameTime={} seekTime={} prevSeekTime={} active={} prevActive={} bones={} prevBones={} controllers={} prevControllers={}",
                renderFrameId,
                animatable.getEntity().getId(),
                getModelId(animatable),
                reason,
    ...
    public static void endEvaluation(@Nullable Scope scope) {
        ...
        if (repeated && GeneralConfig.safeGet(GeneralConfig.WARN_REPEATED_ANIMATION_EVALUATION, true)) {
            YesSteveModel.LOGGER.warn("[YSM-ANIM] repeated evaluation frame={} entity={} model={} count={} costMs={}",
        ...
        if (GeneralConfig.safeGet(GeneralConfig.ANIMATION_DEBUG_LOG, false)) {
            YesSteveModel.LOGGER.info("[YSM-ANIM] eval frame={} entity={} model={} tick={} partial={} frameTime={} renderTick={} seekTime={} active={} firstPerson={} repeated={} evalCount={} bones={} controllers={} costMs={}",
                    scope.renderFrameId,
                    scope.entityId,
                    scope.modelId,
                    scope.tickCount,
    ...
    public static void logControllerState(AnimatableEntity<?> animatable, AnimationEvent<?> event, float seekTime) {
        ...
        if (animatable instanceof PlayerCapability playerCapability) {
            YesSteveModel.LOGGER.info("[YSM-ANIM] state frame={} entity={} model={} tick={} partial={} seekTime={} limbSwing={} limbSwingAmount={} moving={} renderState={} rsWalkSpeed={} rsWalkPos={} controllers=[{}]",
                    renderFrameId,
                    animatable.getEntity().getId(),
                    getModelId(animatable),
                    event.getTickCount(),
            ...
            YesSteveModel.LOGGER.info("[YSM-ANIM] state frame={} entity={} model={} tick={} partial={} seekTime={} limbSwing={} limbSwingAmount={} moving={} controllers=[{}]",
                    renderFrameId,
                    animatable.getEntity().getId(),
                    getModelId(animatable),
                    event.getTickCount(),
