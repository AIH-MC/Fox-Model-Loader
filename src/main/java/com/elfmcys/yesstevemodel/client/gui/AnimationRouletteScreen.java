...
public class AnimationRouletteScreen extends Screen {
    ...
    public void init() {
        ...
        addRenderableWidget(new FlatColorButton(this.centerX + 125, this.centerY - 46, 145, 22, Component.translatable("gui.yes_steve_model.roulette.editor.edit"), button5 -> {
