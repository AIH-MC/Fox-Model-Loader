...
/*             GuiGraphicsExtractor.renderTooltip(this.font, this.font.split(mutableComponentWithStyle, 320), mouseX, mouseY); */
    ...
    public void renderModelPreview(GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick) {
        ...
        if (localPlayer != null) {
            ...
            if (!ModelPreviewRenderer.renderCustomLocalPlayerPreview(extractor, localPlayer, previewLeft, previewTop, previewRight, previewBottom, (previewLeft + previewRight) * 0.5f, previewTop + 150.0f, 70.0f, 0.0f, partialTick, false)) {
