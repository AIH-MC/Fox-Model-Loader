...
public class DownloadScreen extends Screen {
    ...
    private void renderTasks(GuiGraphics guiGraphics) {
        ...
        if (rows.isEmpty()) {
            guiGraphics.drawCenteredString(this.font, Component.translatable("gui.yes_steve_model.resource_station.no_downloads"), this.guiLeft + pw / 2, this.guiTop + 92, 0xFF8F8F8F);
            return;
        }
