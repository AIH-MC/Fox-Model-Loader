...
public class CategoryNameDialogScreen extends Screen {
    ...
    public void init() {
        ...
        addRenderableWidget(new FlatColorButton(this.guiLeft + 52, this.guiTop + 62, 64, 18, Component.translatable("gui.yes_steve_model.model_select.confirm"), button -> confirm()));
        addRenderableWidget(new FlatColorButton(this.guiLeft + 144, this.guiTop + 62, 64, 18, Component.translatable("gui.yes_steve_model.config.cancel"), button -> Minecraft.getInstance().setScreen(this.parent)));
    }
